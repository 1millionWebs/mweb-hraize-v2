...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full shadow-lg bg-cream-100/80 backdrop-blur-md">
      <div className="hidden md:flex items-center justify-between px-4 sm:px-6 lg:px-8 py-1.5 border-b border-navy-800 bg-navy-900">
        <div className="flex items-center gap-4 mx-auto max-w-7xl w-full">
          ...
          <div className="flex items-center gap-2 ml-auto">
            <a href="https://linkedin.com/company/hraize" target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-md text-sage-100/50 hover:text-sky-400 hover:bg-white/5 transition-colors">
            ...
            <a href="https://facebook.com/hraize" target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-md text-sage-100/50 hover:text-sky-400 hover:bg-white/5 transition-colors">
            ...
            <a href="https://instagram.com/hraize" target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-md text-sage-100/50 hover:text-sky-400 hover:bg-white/5 transition-colors">
        ...
        <nav className="hidden md:ml-10 md:flex md:items-center md:gap-x-8">
          <Link
            ...
            className={`text-sm font-semibold transition-colors duration-200 ${
              isActive("/") ? "text-sky-600" : "text-navy-900/80 hover:text-sky-600"
            }`}
          >
            Home
          </Link>
          ...
          <Link
            ...
            onClick={closeMenus}
            className={`text-sm font-semibold transition-colors duration-200 ${
              isActive("/about") ? "text-sky-600" : "text-navy-900/80 hover:text-sky-600"
            }`}
          >
            About us
          </Link>
          ...
          >
            <button
              ...
              className={`flex items-center gap-1 text-sm font-semibold transition-colors duration-200 cursor-pointer ${
                isServiceActive ? "text-sky-600" : "text-navy-900/80 hover:text-sky-600"
              }`}
            >
              Services
          ...
          >
            <button
              ...
              className={`flex items-center gap-1 text-sm font-semibold transition-colors duration-200 cursor-pointer ${
                isCareerActive ? "text-sky-600" : "text-navy-900/80 hover:text-sky-600"
              }`}
            >
              Careers

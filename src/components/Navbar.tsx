  ...
  return (
    <header id="main-header" className={`sticky top-0 z-50 w-full border-b transition-all duration-500 ${
      atTop
        ...
        : "bg-[#1E293B] border-slate-700 shadow-md"
    }`}>
          ...
          <div className="flex flex-col min-w-0">
            <div className="flex items-baseline space-x-1.5">
              <span className={`text-2xl font-black tracking-widest transition-all duration-300 truncate ${
                atTop ? "text-black group-hover:text-gray-600" : "text-white group-hover:text-slate-200"
              }`}>
        ...
        <nav id="desktop-nav" className="hidden md:ml-10 md:flex md:items-center md:gap-x-8">
          ...
          <Link
            ...
            className={`text-sm font-semibold transition-colors duration-200 ${
              isActive("/") ? "text-[#0EA5E9]" : atTop ? "text-[#1E293B] hover:text-[#0EA5E9]" : "text-white hover:text-[#0EA5E9]"
            }`}
          >
            Home
          </Link>
          ...
          <Link
            ...
            onClick={closeMenus}
            className={`text-sm font-semibold transition-colors duration-200 ${
              isActive("/about") ? "text-[#0EA5E9]" : atTop ? "text-[#1E293B] hover:text-[#0EA5E9]" : "text-white hover:text-[#0EA5E9]"
            }`}
          >
            About us
          </Link>
          ...
          >
            <button
              ...
              className={`flex items-center gap-1 text-sm font-semibold transition-colors duration-200 cursor-pointer ${
                isServiceActive ? "text-[#0EA5E9]" : atTop ? "text-[#1E293B] hover:text-[#0EA5E9]" : "text-white hover:text-[#0EA5E9]"
              }`}
            >
              Services
        ...
        <div className="flex items-center md:hidden">
          <button
            ...
            className={`inline-flex items-center justify-center rounded-md p-2 transition-colors duration-300 focus:outline-none ${
              atTop ? "text-gray-600 hover:bg-gray-100 hover:text-gray-900" : "text-gray-400 hover:bg-slate-800 hover:text-white"
            }`}
          >
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            className={`md:hidden border-t px-4 py-4 space-y-2 transition-colors duration-300 ${
              atTop ? "border-gray-200 bg-white" : "border-slate-700 bg-[#1E293B]"
            }`}
          >
            <Link
              href="/"
                    ...
                    {cat.items.map((item, itemIdx) => (
                      <Link
                        ...
                        className={`flex items-center w-full px-3 py-0.5 text-xs font-medium transition-colors duration-300 ${
                          atTop ? "text-gray-600 hover:text-gray-900" : "text-slate-300 hover:text-white"
                        }`}
                      >
